...
def main():
    """Create phone call journal entries."""
    ...
    entry = client.create_phone_call(
        ...
        identifiers=[
            {"type": "phone", "value": "+18005559999", "confidence": 0.9}
        ]
    )
    ...
    start = datetime(2024, 1, 20, 14, 15)
    entry = client.create_phone_call(
        ...
        identifiers=[
            {"type": "phone", "value": "+18005551234", "confidence": 0.95}
        ]
    )
